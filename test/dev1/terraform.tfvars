...
# Instance Parameters
vrds_engine_version                     = "10.4"            	# 9.5.7, 9.6.2
...
vrds_allocated_storage                  = "20" 			# Allocated storage in gigabytes
...
vrds_username                           = "pgadmin"		# Required (unless a snapshot_identifier is provided)
db_password   	                        = "h3ll0there"			# Required (unless a snapshot_identifier is provided). Set using Jana and credtool.
db_family                               = "postgres10.4"		# Required - the family of the DB parameter group
...
vrds_port                               = "5432"		# Optional - the port on which the DB accepts connections
...
vrds_port_ro				= "5432"		# Optional - the port on which the DB accepts connections
